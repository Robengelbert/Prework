...
$forename, $surname, $username, $password, $age, $email</body></html>";
	...
	//This is where you would enter the posted fields into the database,
...
<style>
		...
		<script>
			...
			function validateEmail(field)
			{
				if (field == "") return "No Email was entered.\n"
					...
					(field.indexOf("0") > 0)) || /[^a-zA-Z0-9.@_-]/.test(field))
	...
	<body>
		<table class="signup" border="0" cellpadding="2" celspacing="5" bgcolor="#eeeeee">
