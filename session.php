...
if (isset($_SEVER['PHP_AUTH_USER']) &&
	...
	$un_temp = mysql_entities_fix_string($connection, $_SEVER['PHP_AUTH_USER']);
	$pw_temp = mysql_entities_fix_string($connection, $_SEVER['PHP_AUTH_PW']);
...
{
	return htmlentites(mysql_fix_string($connection, $string));
}
